...
public class createBalorazioWhiteTestBD {
    ...
    public void setUp() {
        ...
        sut = new DataAccess(db); // Constructor berria, db pasatzen duena
        sut.open();
    }
    ...
    public void test1() throws Exception {
        Balorazio result = sut.createBalorazio(8, "Bidaia ondo joan da", "02/01/2025", "12345678A", 12);
        assertNull(result);
    }
    ...
    public void test4() throws Exception {
        ...
        Balorazio b1 = new Balorazio(8, "Ondo", "01/01/2025", r, t1);
        db.persist(b1);
