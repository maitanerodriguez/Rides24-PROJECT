...
public class ReportsCreatedTGUI extends JFrame {
	...
	public ReportsCreatedTGUI (Traveler t) {
		this.getContentPane().setLayout(null);
		this.setSize(new Dimension(500, 409));
		this.setTitle(ResourceBundle.getBundle("Etiquetas").getString("TravelerGUI.MainTitle")+" > "+ResourceBundle.getBundle("Etiquetas").getString("TravelerGUI.reportsCreated"));
		setResizable(false);
		...
		lblReports = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("TravelerGUI.reportsCreated")); //$NON-NLS-1$ //$NON-NLS-2$
		lblReports.setBounds(77, 102, 346, 14);
		getContentPane().add(lblReports);
		
		ImageIcon reportsReceivedIcon= new ImageIcon("./ikonoak/createReport.png");
		...
		jButtonShowReports.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				List<Erreklamazio> erreklamazioak=HasierakoGUI.getBusinessLogic().getCreatedReports(t.getNAN());
