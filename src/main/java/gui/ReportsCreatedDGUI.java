...
public class ReportsCreatedDGUI extends JFrame {
	...
	public ReportsCreatedDGUI (Driver d) {
		this.getContentPane().setLayout(null);
		this.setSize(new Dimension(500, 409));
		this.setTitle(ResourceBundle.getBundle("Etiquetas").getString("DriverGUI.MainTitle")+" > "+ResourceBundle.getBundle("Etiquetas").getString("TravelerGUI.reportsCreated"));
		setResizable(false);
		...
		jButtonShowReports.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				List<Erreklamazio> erreklamazioak=HasierakoGUI.getBusinessLogic().getCreatedReports(d.getNAN());
