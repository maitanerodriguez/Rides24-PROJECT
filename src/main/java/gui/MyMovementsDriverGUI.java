...
public class MyMovementsDriverGUI extends JFrame{
	...
	public MyMovementsDriverGUI(Driver d) {
		...
		jButtonBack.setBounds(207,298,80,30);
		...
		lblErreserbak.setBounds(31, 71, 125, 14);
		...
		jButtonShowMovements.setBounds(139,257,209,30);
		...
		jButtonShowMovements.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				List<Mugimendua> mugimenduak=HasierakoGUI.getBusinessLogic().getMugimenduak(d.getNAN());
