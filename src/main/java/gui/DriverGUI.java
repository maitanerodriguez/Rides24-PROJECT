...
public class DriverGUI extends JFrame {
	...
	private final JMenuItem createRidesItem;
	private final JMenuItem languageItem; 
	private final JMenuItem myRides;
	private final JMenuItem logOut;
	private final JMenuItem kotxeaGehitu;
	private final JMenuItem myCars;
	...
	public DriverGUI(Driver d)
	{
		...
		jLabelSaldo=new JLabel (ResourceBundle.getBundle("Etiquetas").getString("TravelerGUI.yourBalance")+" "+HasierakoGUI.getBusinessLogic().eskuratuDirua(d.getNAN()));
		...
		*/
		...
		Image sortuBidaiakIconEskalatuta = sortuBidaiakIcon.getImage().getScaledInstance(15, 15, java.awt.Image.SCALE_SMOOTH);
		createRidesItem = new JMenuItem(ResourceBundle.getBundle("Etiquetas").getString("DriverGUI.CreateRides"));
		createRidesItem.setIcon(new ImageIcon(sortuBidaiakIconEskalatuta));
		menu.add(createRidesItem);
		
		createRidesItem.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				JFrame a = new SortuBidaiaGUI(driver);
				a.setVisible(true);
		...
		ImageIcon bidaiakIcon= new ImageIcon("./ikonoak/bidaiak.png");
		Image bidaiakIconEskalatuta = bidaiakIcon.getImage().getScaledInstance(15, 15, java.awt.Image.SCALE_SMOOTH);
		myRides = new JMenuItem(ResourceBundle.getBundle("Etiquetas").getString("DriverGUI.myRides"));
		myRides.setIcon(new ImageIcon(bidaiakIconEskalatuta));
		menu.add(myRides);
		myRides.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				JFrame a = new MyRidesGUI(d);
				a.setVisible(true);
				a.setLocationRelativeTo(null);
				//setVisible(false);
				dispose();
		...
		ImageIcon kotxeIcon= new ImageIcon("./ikonoak/addCar.png");
		Image kotxeIconEskalatuta = kotxeIcon.getImage().getScaledInstance(15, 15, java.awt.Image.SCALE_SMOOTH);
		kotxeaGehitu = new JMenuItem(ResourceBundle.getBundle("Etiquetas").getString("KotxeaGehituGUI.addCar"));
		kotxeaGehitu .setIcon(new ImageIcon(kotxeIconEskalatuta));
		menu.add(kotxeaGehitu);
		kotxeaGehitu .addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				JFrame a = new KotxeaGehituGUI(d);
				a.setVisible(true);
				a.setLocationRelativeTo(null);
				//setVisible(false);
				dispose();
		...
		ImageIcon myCarsIcon= new ImageIcon("./ikonoak/kotxe.png");
		Image myCarsIconEskalatuta = myCarsIcon.getImage().getScaledInstance(15, 15, java.awt.Image.SCALE_SMOOTH);
		myCars = new JMenuItem(ResourceBundle.getBundle("Etiquetas").getString("DriverGUI.myCars"));
		myCars .setIcon(new ImageIcon(myCarsIconEskalatuta));
		menu.add(myCars);
		myCars .addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				JFrame a = new MyCarsGUI(d);
				a.setVisible(true);
				a.setLocationRelativeTo(null);
				//setVisible(false);
				dispose();
		...
		myMovements .addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				JFrame a = new MyMovementsDriverGUI(d);
				a.setVisible(true);
				a.setLocationRelativeTo(null);
				//setVisible(false);
				dispose();
		...
		reportsReceived .addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				JFrame a = new ReportsReceivedDGUI(d);
				a.setVisible(true);
				a.setLocationRelativeTo(null);
				//setVisible(false);
				dispose();
		...
		menu.add( reportsCreated);
		 reportsCreated .addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				JFrame a = new ReportsCreatedDGUI(d);
				a.setVisible(true);
				a.setLocationRelativeTo(null);
				//setVisible(false);
				dispose();
		...
		languageItem.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				JFrame a = new LanguageDriverGUI(d);
				a.setVisible(true);
				a.setLocationRelativeTo(null);
				//setVisible(false);
				dispose();
		...
		this.setTitle(ResourceBundle.getBundle("Etiquetas").getString("DriverGUI.MainTitle")+ " - "+driver.getIzena());
	}
	...
	private void paintAgain() {
		...
		this.setTitle(ResourceBundle.getBundle("Etiquetas").getString("MainGUI.MainTitle")+ " - driver : "+driver.getIzena());
		createRidesItem.setText(ResourceBundle.getBundle("Etiquetas").getString("HasierakoGUI.Register"));
	}
	*/
