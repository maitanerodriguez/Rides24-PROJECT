...
public class ReportsReceivedDGUI extends JFrame {
	...
	public ReportsReceivedDGUI (Driver d) {
		this.getContentPane().setLayout(null);
		this.setSize(new Dimension(500, 409));
		this.setTitle(ResourceBundle.getBundle("Etiquetas").getString("DriverGUI.MainTitle")+" > "+ResourceBundle.getBundle("Etiquetas").getString("TravelerGUI.reportsReceived"));
		setResizable(false);
		...
		jButtonShowReports.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				List<Erreklamazio> erreklamazioak=HasierakoGUI.getBusinessLogic().getReceivedReports(d.getNAN());
